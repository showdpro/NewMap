...
import in.mapbazar.mapbazar.Adapter.My_order_detail_adapter;
...
public class MyOrderDetail extends AppCompatActivity {
    ...
    private CustomTextView tv_date, tv_time, tv_total, tv_delivery_charge;
...
//            }
//        });
        tv_date = (CustomTextView) findViewById(R.id.tv_order_Detail_date);
        tv_time = (CustomTextView) findViewById(R.id.tv_order_Detail_time);
        tv_delivery_charge = (CustomTextView) findViewById(R.id.tv_order_Detail_deli_charge);
        tv_total = (CustomTextView) findViewById(R.id.tv_order_Detail_total);
    ...
    private void makeGetOrderDetailRequest(String sale_id) {
        ...
        CustomVolleyJsonArrayRequest jsonObjReq = new CustomVolleyJsonArrayRequest(Request.Method.POST,
                Url.ORDER_DETAIL_URL, params, new Response.Listener<JSONArray>() {
            ...
            public void onErrorResponse(VolleyError error) {
                VolleyLog.d("details", "Error: " + error.getMessage());
    ...
    private void makeDeleteOrderRequest(String sale_id, String user_id) {
        ...
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                Url.DELETE_ORDER_URL, params, new Response.Listener<JSONObject>() {
