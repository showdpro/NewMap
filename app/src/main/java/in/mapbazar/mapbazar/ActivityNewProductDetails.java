...
public class ActivityNewProductDetails extends AppCompatActivity {
...
//    List<NewProductAttributeItem> newProductSizeItemList;
//    List<NewProductAttributeItem> newProductAttributeItemList;
//
...
//                txt_product_prise.setText(sPref.getString("CUR", "") + " " + productItem.getProductAttribute().get(0).getAttributeName());
//
...
//                    selectSizeDialogFragment.setNewProductItem(productItem);
...
//        }
//
//        newProductSizeItemList = productItem.getProductAttribute();
//
//        if (newProductSizeItemList != null && newProductSizeItemList.size() > 0) {
//            String str_size = "";
//            for (int i = 0; i < newProductSizeItemList.size(); i++) {
//                NewProductAttributeItem newProductSizeItem = newProductSizeItemList.get(i);
//
//                if (i == newProductSizeItemList.size() - 1)
//                    str_size = str_size + newProductSizeItem.getAttributeName();
//                else
//                    str_size = str_size + newProductSizeItem.getAttributeName() + "|";
//
//
//               // colorlist.add(newProductSizeItem.getSizeColor());
//
//            }
...
//        }
//
//        newProductAttributeItemList = productItem.getProductAttribute();
//
//        if (newProductAttributeItemList != null && newProductAttributeItemList.size() > 0) {
//            setAttributeView(newProductAttributeItemList);
//        } else {
...
//    }
//
//    public void setAttributeView(List<NewProductAttributeItem> newProductAttributeItemList) {
//        layout_attribute.removeAllViews();
//
//        for (int i = 0; i < newProductAttributeItemList.size(); i++) {
//
//            LayoutInflater inflater = getLayoutInflater();
...
//
//            NewProductAttributeItem newProductAttributeItem = newProductAttributeItemList.get(i);
//
//            txt_attribute_name.setText(newProductAttributeItem.getAttributeName());
//            txt_attribute_value.setText(newProductAttributeItem.getAttributeValue());
//
...
//                Log.e(Common.TAG, "onResponse-details" + resp);
//                if (resp != null) {
...
//            //Adapter for New Products
//            RecentproductAdapter newproduct_adpter = new RecentproductAdapter(ActivityNewProductDetails.this, recentlyProductItemList,null);
...
//        Context context;
//        String Image_path;
//        List<in.mapbazar.mapbazar.Model.HomeData.ProductImageItem> banner;
//        // ViewHolder holder;
//        LayoutInflater inflater;
//
//        // int positiondata;
//
//        public RecentlyProductViewPagerAdapter(Context context, List<in.mapbazar.mapbazar.Model.HomeData.ProductImageItem> banner) {
...
//
//            in.mapbazar.mapbazar.Model.HomeData.ProductImageItem imageItem = banner.get(position);
//
...
//            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
//                JsonObject resp = response.body();
//                Log.e(Common.TAG, "onResponse-new_product" + resp);
//                if (resp != null) {
//                    if (resp.get("status").getAsString().equals("success")) {
//
//                        JsonArray recent_product;
