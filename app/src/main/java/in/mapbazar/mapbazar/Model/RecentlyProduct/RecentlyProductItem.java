...
public class RecentlyProductItem implements Serializable {
	...
	private List<RevcentlyProductAttributeItem> productAttribute;
	private String productStatus;
	private List<RecentlyProductSizeItem> productSize;
	...
	public void setProductAttribute(List<RevcentlyProductAttributeItem> productAttribute){
		this.productAttribute = productAttribute;
	}

	public List<RevcentlyProductAttributeItem> getProductAttribute(){
	...
	public void setProductSize(List<RecentlyProductSizeItem> productSize){
		this.productSize = productSize;
	}

	public List<RecentlyProductSizeItem> getProductSize(){
		return productSize;
	}
