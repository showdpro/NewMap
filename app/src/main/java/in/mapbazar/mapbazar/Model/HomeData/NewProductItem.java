...
public class NewProductItem implements Serializable{
	...
	private List<NewProductAttributeItem> productAttribute;
	private String productStatus;
	private List<NewProductSizeItem> productSize;
	...
	public void setProductAttribute(List<NewProductAttributeItem> productAttribute){
		this.productAttribute = productAttribute;
	}

	public List<NewProductAttributeItem> getProductAttribute(){
	...
	public void setProductSize(List<NewProductSizeItem> productSize){
		this.productSize = productSize;
	}

	public List<NewProductSizeItem> getProductSize(){
		return productSize;
	}
