...
import in.mapbazar.mapbazar.ActivityRecentlyProductDetails;
...
public class RecentproductAdapter extends RecyclerView.Adapter<RecentproductAdapter.MyViewHolder> {
    ...
    public RecentproductAdapter(AppCompatActivity activity, List<RecentlyProductItem> newProductsList, HomeFragment homeFragment) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.rl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(activity,""+newProductItem.getProductId(),Toast.LENGTH_LONG).show();
...
//                        +"\n "+newProductItem.getProductAttribute()+"\n "+newProductItem.getProductImage()+"\n "+newProductItem.,Toast.LENGTH_LONG).show();
                int qty = 0;
                if (!newProductItem.getQuantity().equals(""))
                    qty = Integer.parseInt(newProductItem.getQuantity());
        ...
        if (newProductItem.getProductAttribute() != null) {
            ...
            holder.ly_select_weight.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selectSizeDialogFragment.setRecentlyProductItem(newProductItem);
    ...
    public interface OnItemMinsClick {
        void onItemClick(View view, RecentlyProductItem obj, int position);
    }

    public void setOnItemPlusClick(OnItemPuchClick onItemClickListener) {
        this.onItemPuchClick = onItemClickListener;
    }
    public void setOnItemMinusClick(OnItemMinsClick onItemClickListener) {
    ...
    private void requestCheck_stock_for_add_to_cart(final RecentlyProductItem productItem, String str_sizeid, String str_colorcode,final String quantity) {
...
//                        }
    ...
    private void GetJsonObject(RecentlyProductItem item,String quantity) {
