...
import in.mapbazar.mapbazar.ActivityMatchProductDetails;
...
public class MatchWithproductAdapter extends RecyclerView.Adapter<MatchWithproductAdapter.MyViewHolder> {
    ...
    public MatchWithproductAdapter(AppCompatActivity activity, List<MatchProductItem> newProductsList) {
        ...
        if (newProductItem.getProductAttribute() != null) {
            ...
            holder.ly_select_weight.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    selectSizeDialogFragment.setMatchProductItem(newProductItem);
    ...
    private void requestCheck_stock_for_add_to_cart(final MatchProductItem productItem, String str_sizeid, String str_colorcode,final String quantity) {
...
//                            if (stock_flag == 1) {
    ...
    private void GetJsonObject(MatchProductItem item,String quantity) {
